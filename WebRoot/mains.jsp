			...
			<div id="page">
				...
				<div id="content">
					<div class="post">
						...
						<p class="byline">2014年11月19号Fjnu_CDIO_6完成界面原型</p>
						<div class="entry">
							<p>
								<strong>C语言是一种计算机程序设计语言。它既有高级语言的特点，又具有汇编语言的特点。它可以作为系统设计语言，
									编写工作系统应用程序，也可以作为应用程序设计语言，编写不依赖计算机硬件的应用程序。因此，它的应用范围广泛。 主要有以下特点：
									C语言在很多方面都可以用，不仅仅是在软件开发上，各类科研都是需要用到C语言的。具体应用比如我是学硬件的，
									单片机以及嵌入式系统都可以用C来开发。 C 语言发展如此迅速, 而且成为最受欢迎的语言之一,主要因为它具有强大的功能。
									许多著名的系统软件, 如DBASE Ⅲ PLUS、DBASE Ⅳ 都是由C 语言编写的。 用C语言加上一些汇编语言子程序,
									就更能显示C 语言的优势了, 像PC- DOS 、WORDSTAR等就是用这种方法编写的。 </strong>
							</p>
						</div>
					</div>
					<div class="post">
					...
					<div class="post">
						...
						<div class="entry">
							<p>简洁紧凑、灵活方便C语言一共只有32个关键字,9种控制语句，程序书写自由，
								主要用小写字母表示。它把高级语言的基本结构和语句与低级语言的实用性结合起来。 C
								语言可以象汇编语言一样对位、字节和地址进行操作, 而这三者是计算机最基本的工作单元。</p>
							<p class="links">
								<a href="#" class="more">查看更多吗？？</a>
							</p>
						</div>
